...
model_alur_path = os.path.join(current_dir, 'D:\EXE\model_alur_naive_bayes.pkl')
model_tema_path = os.path.join(current_dir, 'D:\EXE\model_tema_naive_bayes.pkl')
vectorizer_path = os.path.join(current_dir, 'D:\EXE\model_vectorizer.pkl')
csv_orang_path = os.path.join(current_dir, 'D:\EXE\orang.csv')
csv_tempat_path = os.path.join(current_dir, 'D:\EXE\datatempat.csv')
bg_image_path = os.path.join(current_dir, 'D:\EXE\Background.png')
